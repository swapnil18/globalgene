...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        if ( ! $this->input->is_ajax_request() AND $this->config->item('rest_ajax_only'))
        {
    ...
    public function _remap($object_called, $arguments)
    {
        ...
        if ($this->config->item('force_https') AND !$this->_detect_ssl())
        {
    ...
    {
        $status = $this->rest->db->insert($this->config->item('rest_logs_table'), array(
                    'uri' => $this->uri->uri_string(),
                    'method' => $this->request->method,
                    'params' => $this->_args ? ($this->config->item('rest_logs_json_params') ? json_encode($this->_args) : serialize($this->_args)) : null,
    ...
    protected function _check_access() 
    {
        ...
        $query = $this->rest->db->get($this->config->item('rest_access_table'));
